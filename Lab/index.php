                      ...
                      <div class='card-stacked'>
                        <div class='card-content'>
                         ...
                         <div class='card-action'>
                                    <a href='tests.php?hospital_no=$hospital_no?id=$id' class='btn blue darken-4'>Add Tests</a>
                                    <a href='#modal1?hospital_no=$hospital_no?id=$id' class='btn brown modal-trigger'>Recent Tests</a>
                                </div>
