...
<body>
    <ul id="slide-out" class="side-nav fixed">
        ...
        <li>
            <a class="waves-effect uppercase" href="scan.php"><i class="material-icons">person_add</i>Scan</a>
        </li>



        <li>
            <a class="waves-effect uppercase" href="allpatients_scans.php"><i class="material-icons">visibility</i>View
                Patient</a>
        </li>
        <li>
            <div class="divider"></div>
            ...
            <div class="nav-wrapper">
                <div class="container">
                    ...
                    <<a href="#" class="brand-logo center">
                        <img src="../assets/images/lasu logo.png" width="200" style="margin-top: 1.5px;;" class="img-responsive" alt="Image">
                        </a>
                </div>
            </div>
        </nav>
