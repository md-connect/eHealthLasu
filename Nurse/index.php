                      ...
                      <div class='card-stacked'>
                        <div class='card-content'>
                         ...
                         <div class='card-action'>
                                    <a href='vitalsigns.php?hospital_no=$hospital_no?id=$id' class='btn blue darken-4'>Add Vitals</a>
                                    <a href='#modal1?hospital_no=$hospital_no?id=$id' class='btn brown modal-trigger'>Recent Vitals</a>
                                </div>
...
<main>
    ...
    <div id="modal1" class="modal modal-fixed-footer">
        <div class="modal-content">
            <h4>Modal Header</h4>
            <p><?php echo $all_patient_vitals; ?></p>
